...
## Content Delivery > Image Manager > エラーコード { #content-delivery-image-manager-error-code }
...
| 11005      | UPLOAD_FILE_COUNT_LIMIT | The number of files uploaded in a single request exceeded the limit. |
| 11006      | INVALID_MULTIPART_CONTENT_TYPE | Invalid multipart content type. Use 'multipart/form-data'. |
