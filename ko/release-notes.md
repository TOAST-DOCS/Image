...
* [Console] [폴더 및 이미지 파일 관리](./console-guide/#manage-folders-and-image-files)
...
* [API] 처리 결과 Callback에 덮어쓰기 되었는지 여부 표시 추가
	* [다중 이미지 업로드](./api-guide/#upload-multiple-files)
	* [이미지 오퍼레이션 실행](./api-guide/#execute-image-operations-asynchronous)
...
#### 기능 개선/변경
* [이미지 처리 기능 추가](./api-guide/#image-operation-api)
	* 이미지 분할 기능에 격자 분할 추가
	* 워터마크 기능 추가
* [Console] [이미지 처리 옵선 추가](./console-guide/#manage-thumbnail-options)
...
* [Console] [이미지 처리 기능에 따라 Grouping](./console-guide/#manage-thumbnail-options)
...
* [Console] [상품 종료 프로세스 변경](./console-guide/#delete-all-files)
...
#### 기능 개선/변경
* [섬네일 크기 조절 방식 추가](./console-guide/#manage-thumbnail-options)
    * Option의 가로 세로에 맞게 Size 변경
    * Option의 가로 기준 Size 변경
    * Option의 세로 기준 Size 변경
* [크롭 방식 추가](./console-guide/#manage-thumbnail-options)
    * Slice Crop 추가
* [Console] [Gif 애니메이션 유지 옵션 글로벌 설정으로 변경](./console-guide/#manage-thumbnail-options)
